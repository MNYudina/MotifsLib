...
import com.asoiu.motifs.exception.GraphStatsException;
...
public static void main(String[] args) throws GraphStatsException {
  ...
  // Graph graph = initGraph("Twitter_obr.net");
   ...
   ParallelDirThreeSizeSubgraphsCounterFullEnumeration <Integer, Integer> p4= new ParallelDirThreeSizeSubgraphsCounterFullEnumeration(graph,8);
