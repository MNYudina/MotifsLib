...
import com.asoiu.motifs.ParallelDirThreeSizeSubgraphsCounterSampling.VertexLayerParameters;
import com.asoiu.motifs.exception.UnsupportedEdgeTypeException;
 ...
 * @author Yudina Maria
 */
public class ParallelDirThreeSizeSubgraphsCounterFullEnumeration<V, E>  {
	 ...
	 */
	public ParallelDirThreeSizeSubgraphsCounterFullEnumeration(Graph<V, E> graph, int numberOfThreads) {
		this.graph = graph;
